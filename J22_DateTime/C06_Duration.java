...
public class C06_Duration {
    public static void main(String[] args) {
        ...
        Duration fark=Duration.between(gece,oglen);//öğlen ile gece arasındaki zaman farkı atandı
        ...
        System.out.println("fark.toMinutes() = " + fark.toMinutes());//fark bilgisi dakikaya çevrildi

...
public class C01_ArithmeticException {
    public static void main(String[] args) {
        ...
        try {//dene-> hatanın olma ihitmali oldugu code block
            /*
            1- try-catch kullanıldıgında try block hatasız çalışırsa catch block asla çalışmaz. Catch block try block exception hatq yakalarsa calışır
...
*/
            ...
            oran = sayi1 / sayi2;//try block'da hata yakalandığı satırdan sonra try diğer satırlar değil ilgili catch block çalışır

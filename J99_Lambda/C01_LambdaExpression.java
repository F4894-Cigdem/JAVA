...
public class C01_LambdaExpression {
    ...
    //Task : "Structured Programming" kullanarak list elemanlarını aynı
    // satirda aralarında bosluk olacak sekilde print ediniz.
    ...
    //Task : "Functional Programming" kullanarak list elemanlarını aynı
    // satirda aralarında bosluk olacak sekilde print ediniz.

    public static void printElFunctional(List<Integer> sayi) {

        sayi.stream().forEach((t) -> System.out.print(t + " "));//functional pr.
    ...
    */
    ...
    public static void printElFunctional1(List<Integer> sayi) {
        ...
        sayi.stream().forEach((System.out::print));//method referance->system.out yapısında print call edildi
        //methodKaynağı::method ->meth reference

    }

    public static void yazdir(int a) {//normal tek aksiyonlu ->seed method ->refere edilecek method
        System.out.print(a + " ");
    ...
    public static void printElFunctional2(List<Integer> sayi) {
        ...
        sayi.stream().forEach((C01_LambdaExpression::yazdir));

 ...
 */
    ...
    public static void matBolmSays(List <Universite>unv) {

        System.out.println("Matematik bölüm sayısı : " +unv.stream().filter(t -> t.getBolum().toLowerCase().equals("matematik")).count());
    }
    //task 10-->Ogrenci sayilari 571'dan fazla olan universite'lerin en buyuk notOrt'unu bulunuz.

    public static void BykOrt(List <Universite>unv) {
    ...
    public static void KckOrt(List <Universite>unv) {
